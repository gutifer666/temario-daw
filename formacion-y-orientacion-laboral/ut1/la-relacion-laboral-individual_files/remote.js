...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},V:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",V:[{G:"div",L:"ytp-mdx-popup-title",va:"No has iniciado sesi\u00f3n"},{G:"div",L:"ytp-mdx-popup-description",va:"Los v\u00eddeos que veas podr\u00edan aparecer en el historial de reproducciones de la TV e influir en las recomendaciones. Puedes evitarlo si cancelas e inicias sesi\u00f3n en YouTube desde tu ordenador."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",V:[{G:"button",Ia:["ytp-button","ytp-mdx-privacy-popup-cancel"],
va:"Cancelar"},{G:"button",Ia:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmar"}]}]}]});this.i=new g.LK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.V.call(this,{G:"div",
...
b=g.U(b,128)?g.iH("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",c):b.Jc()||g.U(b,4)?g.iH("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",c):g.iH("Conectado a $RECEIVER_NAME",c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.sP.call(this,"Reproducir en",0,a,b);
...
break;case -1:this.Yb(new g.OI(64));break;case -1E3:this.Yb(new g.OI(128,{errorCode:"mdx.remoteerror",errorMessage:"Este v\u00eddeo no se puede reproducir de forma remota."}))}a=a9(this.Xb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,y0a(this,a));a=a9(this.Xb);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.X.isActive()||this.CP()}else x0a(this)};
...
O9.prototype.xj=function(a){return"cast-selector-receiver"===a?"Enviar...":this.Qo[a].name};
