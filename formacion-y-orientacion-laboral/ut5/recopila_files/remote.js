...
va:"Cancelar"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmar"}]}]}]});this.i=new g.ZK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},E9=function(a){g.W.call(this,{G:"div",
...
b=g.T(b,128)?g.AH("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",c):b.Ec()||g.T(b,4)?g.AH("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",c):g.AH("Conectado a $RECEIVER_NAME",c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},F9=function(a,b){g.wP.call(this,"Reproducir en",0,a,b);
...
F9.prototype.pj=function(a){return"cast-selector-receiver"===a?"Reparto...":this.Ho[a].name};
